...
set(hFig, 'Position', [pos(1) pos(2) pos(3)*1.3 pos(4)*2]);
use_panel = 1;
clf
...
p(1).pack({1},{1/3 1/3 1/3});
p(2).pack({1},{1/3 1/3 1/3});
p(3).pack({1},{1/3 1/3 1/3});
p(4).pack({1},{1/3 1/3 1/3});
