function []=jpg16bits2jpg8bits(filepath)
%Camille Paoletti - 04/2012
%jpg16bits2jpg8bits('L:\common\movies\Camille\2012\201201\120103\HS42')
...
if n==0
    for i=1:n1
        ...
        filesave=strcat(filepath,'\Phase\',name,'_8bits',ext);
    ...
    for i=1:n2
        ...
        filesave=strcat(filepath,'\Fluo\',name,'_8bits',ext);
