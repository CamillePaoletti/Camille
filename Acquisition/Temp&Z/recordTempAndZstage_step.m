function [data] = recordTempAndZstage_step(periode, Tinitial,Tfinal, stepTime,TimeTot, filepath )
...
%data=recordTempAndZstage_step(0.1,30,35,600,1200,filename);
