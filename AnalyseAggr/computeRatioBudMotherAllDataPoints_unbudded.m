function [Data]=computeRatioBudMotherAllDataPoints_unbudded(path,file,position,hsFrame,lastFrame)
%Camille Paoletti - 12/2013
%compute computeRatioBudMother4 for the movie path/file for all position in pos
%and plot boxplot
...
for l=position
    ...
    if a==0
        ...
        [Cc,ratio,area,coupleNum,division,budding,Nrpoints,NrCc]=computeRatioBudMother4_unbudded(hsFrame, lastFrame);
