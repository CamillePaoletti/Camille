function [Cc,ratio,area,coupleNum,division,budding,Nrpoints, NrCc]=computeRatioBudMother4(hsFrame, lastFrame)
...
eventsLen=3;%nombres d'événements (hs, division, budding...)
