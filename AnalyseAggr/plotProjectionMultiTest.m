...
%                     %3stacks projection
%                     C=imread(strcat(pathstr,'-projection-Stacks3With1µmStep','\',Name{1,1},'.jpg'));
%                     D=A-C;
%                     E=A-B;
%                     F=C-B;
%                     figure;
...
%                     figure
%                     subplot(1,2,1);imshow(C,[]);title('3stacks 1µm');
%                     subplot(1,2,2);imshow(D,[]);title('5stacks 1µm');
%
%
%
%                 %end
        ...
        for i=5
            ...
            for k=1:numel(timeLapse.list)
                if timeLapse.list(1,k).enableZStacks
                    ...
                    %3stacks projection
                    I(:,:,b,6)=imread(strcat(pathstr,'-projection-Stacks3With1µmStep','\',Name{1,1},'.jpg'));
                end
