function [concat,nNum]=extract_values_frame(path,file,position,frames)
%[concat,nNum,areaTot,volumeTot]
...
for l=position
    ...
    if a==0
        ...
        [number,fluo,foci,radius,nNum_temp]=compareMeanFociNumber_frame(frames,'all',0);
