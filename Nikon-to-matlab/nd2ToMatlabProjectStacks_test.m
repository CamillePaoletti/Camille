function nd2ToMatlabProjectStacks_test(fileName,binning,stacks,r,meta,option)
...
% timeLapse.seqFrame=[];
% 
% timeLapse.path=['M:\Camille\2014\140505_agingCP03&CP21/test', '/'];
% %timeLapse.path=[pat '/'];
