function nd2ToMatlabProject(r,binning,stacks,nam)
global projarr
...
numSeries = r.getSeriesCount(); % number of frames
numImages = r.getImageCount(); % number of of position
...
timeLapse.path=['/Volumes/charvin1/Camille/nd005/test', '/'];
%timeLapse.path=[pat '/'];
