function [BWs,Raw,R,N,M]=fluoDiffusionAnalysisMultiCav(filename)
...
Choices={'cav 1','cav 2','cav 3','cav 4','cav 5','cav 6'};
...
legend(Choices{1},Choices{2},Choices{3},Choices{4},Choices{5},Choices{6});
xlabel('time(s)');
